...
export default class Gallery extends Component {
    ...
    componentDidMount() {
        this.image = {};
        CameraRoll.getPhotos({ first: 50, assetType: "All" }).then((data) => {
            console.log(data)
            this.setState({
                assets: data.edges
            })
    ...
    _onSelectImage = async (image, index) => {
        ...
        // RNPhotoEditor.Edit({
        //     path: `file:///data/user/0/com.demoredux/cache/Camera/a55bc197-41de-4dfa-a669-b8ec9ddb9e35.jpg`,
        //     onDone: (e) => {
        //         console.log('on done',e)
        //     },
        //     onCancel: () => {
